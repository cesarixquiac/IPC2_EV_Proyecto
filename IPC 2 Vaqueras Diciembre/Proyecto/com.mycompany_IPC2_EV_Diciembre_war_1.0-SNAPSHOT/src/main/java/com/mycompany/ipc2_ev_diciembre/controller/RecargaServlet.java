...
import com.mycompany.ipc2_ev_diciembre.dto.RecargaDTO;
 ...
 * @author cesar
 */
@WebServlet(name = "RecargaServlet", urlPatterns = {"/api/gamer/cartera/recargar"})
public class RecargaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RecargaServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RecargaServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            double saldo = service.recargar(gamerId, dto.getMonto());

            resp.setStatus(HttpServletResponse.SC_OK);
            resp.getWriter().write("{\"mensaje\":\"Recarga exitosa\",\"saldo\":" + saldo + "}");
